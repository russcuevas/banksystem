...
<body>
    ...
    <div class="main">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_SESSION['admin_id'])) {
                                ...
                                echo '<h5 class="card-title">Welcome ' . $admin['username'] . '</h5>';
                            } else {
                                echo '<h5 class="card-title">0</h5>';
                            }
                            ?>
                            <a href="admin_profile.php" class="card-text text-decoration-none">View Profile.</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="view_users.php" class="card-text text-decoration-none">View Users.</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="view_transaction.php" class="card-text text-decoration-none">View Transactions.</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $fetch_users = $conn->prepare("SELECT users.*, wallet.balance 
                                    FROM users 
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header" style="font-weight: 500;">
                            <h4 style="margin-top: 10px">Display Users</h4>
                        </div>
                        <div class="card-body">
                            <div class="row mb-1">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    if ($total_count > 0) {
                                        ...
                                        echo '<tr><td colspan="6"><h1 class="text-center mt-2" style="padding: 55px;">No Users Found</h1></td></tr>';
                                    }
                                    ?>
                                </tbody>
                            </table>
                        ...
                        <div class="col-md-4 text-start">
                            <nav aria-label="Pagination">
                                <ul class="pagination">
                                    <?php if ($page > 1) { ?>
                                        <li class="page-item">
                                            <a class="page-link" href="admin_dashboard.php?page=<?php echo ($page - 1); ?>" aria-label="Previous">
                                    ...
                                    <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                        <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                            <a class="page-link" href="admin_dashboard.php?page=<?php echo $i; ?>">
                                                <?php echo $i; ?>
                                                <?php if ($i == $page) { ?>
                                    ...
                                    <?php if ($page < $total_pages) { ?>
                                        <li class="page-item">
                                            <a class="page-link" href="admin_dashboard.php?page=<?php echo ($page + 1); ?>" aria-label="Next">
