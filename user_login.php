          ...
          <div class="d-flex align-items-center">
            ...
            <div class="p-4" id="formPanel">
              <div class="text-center mb-5">
                <h1 class="customHeading h3 text-uppercase">User | Login</h1>
              </div>
              <form method="POST">
                ...
                <div class="mt-5">
                    ...
                    <a href="user_register.php" class="w-100 p-2 d-block custom-btn-2 text-center text-decoration-none mt-1">Click to register</a>
                    <a href="forgot_password.php" class="w-100 p-2 d-block custom-btn-3 text-center text-decoration-none mt-1"> Forgot your password?</a>
                </div>
              </form>
            </div>
          </div>
